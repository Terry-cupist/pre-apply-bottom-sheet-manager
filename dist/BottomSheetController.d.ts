import { PropsWithChildren, Ref, ComponentType } from "react";
/**
...
export declare const BottomSheetController: <P extends BottomSheetModalProps = BottomSheetModalProps>(props: PropsWithChildren<Props<P>> & {
